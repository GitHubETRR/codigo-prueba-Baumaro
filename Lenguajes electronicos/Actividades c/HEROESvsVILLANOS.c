...
int main(){
    ...
    personaje_t azukita = {"AZUKITA","Azukita es un hombre de unos 40 años, el cual tiene mucho dinero y mucho odio con la sociedad. Con su carisma y su astucia, logro construir un imperio azucarero. En su pasado hizo negocios con el padre de Misil, el cual luego de una pelea, termino muerto.",110,55,45,40,2,25,1,1,1,1,1,{"Cañon T.U 551","ATAQUE","golpea con un cañon de azucar en polvo",80,0,85},{"Pico de glucosa","ATAQUE","pincha a sus enemigos con un pico de azucar aumentando su nivel de azucar en sangre",60,0,90},{"Explosión Dulce","ATAQUE","Genera una explosión azucarada que inflige daño en área, afectando también ligeramente al usuario.",50,0,90},{"Aumento de dealers","DEFENSA","se duplica y aumenta la cantidad de dealers que tiene, aumenta la evacion y cura",0,70,85},{"Cobertura Azucarada","DEFENSA","Crea un escudo cristalino de azúcar que reduce el daño recibido.",0,0,100},{"Regeneración Glucémica","DEFENSA","Usa una fórmula secreta para restaurar su vida.",0,120,0}};
    personaje_t misil = {"MISIL","Misil es un hombre joven, de unos 28 años, con cabello rubio platinado dándole un aspecto retro y agresivo. Está completamente musculoso, con una masa corporal enorme debido a su adicción al gimnasio y al uso excesivo de sustancias, lo que lo hace ver más grande de lo normal. Vive bajo la idea de que el físico perfecto lo es todo, y desprecia a cualquiera que no se alinee con sus ideales de vida \"saludable\". Odia con pasión cualquier estilo de vida que implique el sedentarismo, la comida chatarra o la falta de ejercicio. Este vive con el fin de cumplir su venganza en contra de Azukita.",120,75,50,45,2,25,1,1,1,1,1,{"Tacle Alto","ATAQUE","Un golpe devastador cuyo daño aumenta cuanto menor sea la salud de Misil.",40,0,95},{"Sobredosis Anabólica","ATAQUE","Sacrifica toda su masa muscular para un ataque brutal. Deja al usuario con 1 de vida.",250,0,90},{"Explosión Muscular","ATAQUE","Libera una onda expansiva desde su cuerpo, dañando a todos los oponentes.",70,0,80},{"Sobrecarga Muscular","DEFENSA"},{"DEFENSA"},{"DEFENSA"}};
    ...
    personaje_t Jugador_1;
    personaje_t Jugador_2;
